...
const BlogsHeader: React.FC<BlogsHeaderProps> = ({ context, onNavigate, currentPage }) => {
  // Mock user data (will use AuthContext later)
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0A0E27]/90 backdrop-blur-lg border-b border-[#F7B731]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#pricing" className="text-gray-300 hover:text-[#F7B731] transition">Pricing</a>
        ...
        <div className="fixed top-[72px] left-0 right-0 z-40 bg-[#0A0E27]/95 backdrop-blur-lg border-b border-[#F7B731]/20 max-h-[calc(100vh-72px)] overflow-y-auto md:hidden">
          <div className="px-4 py-6 space-y-4">
            ...
            <nav className="flex flex-col space-y-3">
              ...
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-gray-300 hover:text-[#F7B731] transition py-2 text-lg">Pricing</a>
