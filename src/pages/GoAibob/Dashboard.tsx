    ...
    >
      ...
      {queueStatus && (
        <div className="space-y-3">
          <QueueItem label="Waiting" count={queueStatus.waiting} color="yellow" icon="⏳" />
          <QueueItem label="Processing" count={queueStatus.active} color="blue" icon="⚙️" />
          <QueueItem label="Completed" count={queueStatus.completed} color="green" icon="✅" />
          <QueueItem label="Failed" count={queueStatus.failed} color="red" icon="❌" />
        </div>
      )}
